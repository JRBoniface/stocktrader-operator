...
The [stocktrader-setup repository](https://github.com/IBMStockTrader/stocktrader-setup) provides instructions for setting up these dependencies.
...
* configure OpenTelemetry observability with various backend exporters - see [opentelemetry.md](opentelemetry.md) for details
...
For OpenTelemetry installation instructions, see [opentelemetry.md](opentelemetry.md).
